...
path = r'D:\Users\Admin\Desktop\clientFaces\client1'
        ...
        try:
            for img in img_list:
                ...
                if name in face_count_before_confirm_record:
                    ...
                    if reset_timer_min >= 2: #Count Reset Threshold
                ...
                if (name in face_count_before_confirm_record) and (face_count_before_confirm_record[name]['count'] >= 3):
                    # Check if datetime
                    ...
                    print("Doesnt valid for scanning before reaching count 3")
